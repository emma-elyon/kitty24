...
fn main() -> Result<(), std::io::Error> {
    let source = std::fs::read_to_string("examples/snake.kitty.script").unwrap();
    ...
    // std::fs::write("snake.kitty.asm", &assembly).unwrap();

    // let assembly = std::fs::read_to_string("snake.kitty.asm").unwrap();
